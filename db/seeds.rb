...
request_type1 = RequestType.create! :name => 'Restourantsadssda', :keyword => "cafe,restourant,bar,carryout,coffeshop,pizzeria,teahouse,winebar,snack,pop-up,snackbar,pizza,grill,eatery,coffehouse",
